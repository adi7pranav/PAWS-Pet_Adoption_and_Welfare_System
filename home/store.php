...
$sql1 = " SELECT * FROM store where sid='$uname'";
...
<ul>
      ...
      <li><a href="store.php">Hello, <?php echo $uname; ?></a></li>
  ...
  font-size: 16px;"></th>
      ...
      <tbody>
			<tr>
                ...
                <td><a href="../delete/store.php?nid=<?php echo $rows['sid']; ?>"><button type="button" style="background-color: red;
  border: none;
  color: white;
  padding: 10px 10px;
  border-radius: 5px;
