...
$sql = " select p.pid,p.pname,p.species,p.breed,n.nname,s.sname,v.vname,u.uname from users u,pets p,ngo n,vet v,store s where p.uname=u.uname  and p.sid=s.sid and p.nid=n.nid and n.nid='$uname' and v.vid=p.vid " ;
// --  ORDER BY score DESC ";
$result = $mysqli->query($sql);
$sql1 = " SELECT * FROM ngo where nid='$uname'";
...
<ul>
	 ...
	 <section>
      ...
      <thead>
			...
			<form action="../update/ngo.php" method="post">
            <tr>
		...
		<input type="hidden" name="type" id="type" value="ngo">
